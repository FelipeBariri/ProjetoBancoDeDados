...
namespace ProjetoBancoDeDados.Controllers
{
    public class EventosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeEventos,DataEvento,DescricaoId")] Eventos eventos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeEventos,DataEvento,DescricaoId")] Eventos eventos)
        {
            if (id != eventos.Id)
            {
                return NotFound();
