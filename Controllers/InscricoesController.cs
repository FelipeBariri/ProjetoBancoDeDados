...
namespace ProjetoBancoDeDados.Controllers
{
    public class InscricoesController : Controller
    {
        ...
        {
            var contexto = _context.Inscricoes.Include(i => i.Eventos).Include(i => i.Pagamentos).Include(i => i.Passagens).Include(i => i.Usuarios);
        ...
        {
            ViewData["EventosId"] = new SelectList(_context.Eventos, "Id", "NomeEventos");
        ...
        public async Task<IActionResult> Create([Bind("Id,EventosId,PagamentosId,UsuariosId,PassagensId")] Inscricoes inscricoes)
        {
            ...
            ViewData["EventosId"] = new SelectList(_context.Eventos, "Id", "NomeEventos", inscricoes.EventosId);
